// 3d Console-based rasterizer engine-- johnhs3
// followed tutorial from Javidx9:
// source vid here: https://www.youtube.com/watch?v=nBzCS-Y0FcY
// V4.0

//NOTE: Header files, objects, and textures are left out of the repo for simplicity.
